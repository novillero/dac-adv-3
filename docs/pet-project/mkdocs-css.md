...
Плагин для работы PlantUML-диаграммами [mkdocs_puml](./plant-uml.md) по умолчанию генерирует два варианта диаграммы: для светлой схемы `default` и для тёмной темы `slate`.
